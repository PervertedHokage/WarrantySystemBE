...
public partial class warranty_systemContext : DbContext
{
    ...
    public virtual DbSet<IssuesGroup> IssuesGroups { get; set; }
    ...
    public virtual DbSet<WarrantyClaimAttachment> WarrantyClaimAttachments { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IssuesGroup>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");
        ...
        modelBuilder.Entity<WarrantyClaim>(entity =>
        {
            ...
            entity.Property(e => e.DiagnosisNote).HasMaxLength(200);
            entity.Property(e => e.DiagnosisWorker).HasMaxLength(50);
            ...
            entity.Property(e => e.ReceptionWorker).HasMaxLength(50);
        ...
        modelBuilder.Entity<WarrantyClaimAttachment>(entity =>
        {
            entity.ToTable("warranty_claim_attachments");
            ...
            entity.Property(e => e.FileSize).HasColumnType("long");
            
            entity.HasOne<WarrantyClaim>()
                .WithMany()
